...
<fieldset class="layui-elem-field layui-field-title">
  <legend class="per_title">hello,{$name},欢迎来到个人会员中心 | <a class="layui-bg-green" href="csrf_post.php?logout=1">退出登录</a></legend>
  ...
  <p>住址:{$add}</p> 
  <p>邮箱:{$email}</p> 
  <a class="layui-bg-green" href="csrf_post_edit.php">修改个人信息</a>
  </blockquote>
  </div>
</fieldset>
A;
