...
<span class="layui-badge-dot layui-bg-green"></span>
    ...
    <span class="layui-badge-rim">CSRF(post) login</span>
  ...
  <legend>hello,{$name},欢迎来到个人中心 | <a style="color:bule;" href="csrf_post.php?logout=1">退出登录</a></legend>
  <div class="layui-field-box">
  <form method="get">
  <div class="layui-form-item">
    <label class="layui-form-label">姓名:</label><br>
  ...
  <div class="layui-input-inline"> 
  <input class="add layui-input" type="text" name="add" required  lay-verify="required"   value="{$add}"/><br>
  </div></div> 

  <div class="layui-form-item"> 
  <label class="layui-form-label">邮箱:</label>
  <div class="layui-input-inline"> 
  <input class="email layui-input" type="text" name="email" required  lay-verify="required"   value="{$email}"/><br>
  </div> </div> 
