...
<fieldset class="layui-elem-field layui-field-title">
  ...
  <form class="layui-form" method="get" action="csrf_post_login.php">
...
<script>
  $('#test5').on('click', function(){
    layer.tips('<div  class="layui-bg-gray" style="color:#5FB878;border:8px solid #F0F0F0;"><p style="color:#2F4056;">这里一共有这么些用户lucy/brown/clark/denny/jerry/mark/lili,密码全部是123456</p></div>', '#test5');
  });</script>
